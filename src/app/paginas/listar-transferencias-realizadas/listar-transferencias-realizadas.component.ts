...
@Component({
  selector: 'app-listar-transferencias-realizadas',
  templateUrl: './listar-transferencias-realizadas.component.html',
  styleUrls: ['./listar-transferencias-realizadas.component.scss']
})
export class ListarTransferenciasRealizadasComponent implements OnInit {
  ...
  loadData() {
    ...
    this._aveService.getAveTransferenciaRealizadas(this.criador).subscribe((res) => {
